...
const JOB_TYPES = ['Data Scientist', 'ML Engineer', 'AI Engineer', 'Other']
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <SortTh label="Applied"  sortKey="date_applied" sort={sort} onSort={toggleSort} />
              ...
              <tbody>
                {sorted.map(a => {
                  ...
                  return (
                    <tr key={a.id}>
                      <td style={{ fontSize: '1rem' }}>{ageFlag(daysSince(a.updated_at))}</td>
                      <td>
                      ...
                      <td className="text-muted">{a.date_applied || '—'}</td>
                ...
                {filtered.length === 0 && (
                  <tr>
                    <td colSpan={editMode ? 10 : 9} style={{ textAlign: 'center', color: 'var(--text-muted)', padding: '2rem' }}>
